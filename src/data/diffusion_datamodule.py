...
class DiffusionDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        print(f"Train dir: {self.hparams.train_val_test_dir[0]}")
        print(f"Val dir: {self.hparams.train_val_test_dir[1]}")  
        print(f"Test dir: {self.hparams.train_val_test_dir[2]}")
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            if self.hparams.train_val_test_dir:
                ...
                # Debug prints for dataset sizes
